...
@section('page-title','Academic Rules')
@section('content-title','Academic Rules')
...
@section('content')
    <div class="card">
        ...
        @endif
        <form action="{{url('/academic-rules-insert/'.$data[0]->id)}}"method='post'enctype="multipart/form-data">
            @csrf
