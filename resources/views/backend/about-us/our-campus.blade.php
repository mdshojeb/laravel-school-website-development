...
@section('page-title','About Our Campus Information')
@section('content-title','About Campus Information')
...
@section('content')
    <div class="card">
        ...
        @endif
        <form action="{{url('/about-campus-insert/'.$data[0]->id)}}"method='post'enctype="multipart/form-data">
            @csrf
